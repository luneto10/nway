...
offset = 0
f = open("/Users/luneto10/Documents/Projects/Research/nway/data/hg19.genome", "r")
for l in f:
    a = l.rstrip().split("\t")
    offsets[a[0]] = offset
    offset += int(a[1])
...
for file_name in glob.glob(
    "/Users/luneto10/Documents/Projects/Research/nway/scripts/r.bed"
):
    f = open(file_name, "r")
    ...
    l_s = sorted(line)
    print("\t".join([str(x[0]) + " " + str(x[1]) for x in l_s]))
